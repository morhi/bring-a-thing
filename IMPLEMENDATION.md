...
| 2 | [x] | 49ff9aa, 1b99076 | 2026-09-16 | See commits above. Group admin role, friends address book, and URL slugs (Group/Roster/RosterItem/CustomField) added on request afterward, not yet committed — see Deviations |
| 3 | [x] | 77f65a5, 768a596, b818041 | 2026-09-16 | Backend/tests/`npm run check` verified; browser-confirmed create/edit/duplicate/cascade-delete flows. `b818041` (+ follow-up) added shareable list links and share-link add-things — see Deviations. Roster URL slug and group-admin roster-settings access added on request afterward, not yet committed |
| 4 | [x] | c6025fd | 2026-09-16 | Backend/tests (`php artisan test --compact`, 91 passing) and `npm run check` verified; browser-confirmed claim/edit/remove/custom-fields/members-can-add-items flows over a working ddev+Reverb websocket setup — see Deviations for two bugs found and fixed during that check. Item/custom-field URL slugs and owner/admin claim-for/unclaim-for management added on request afterward, not yet committed |
| 5 | [ ] | | | |
| 6 | [ ] | | | |
| 7 | [ ] | | | |
| 8 | [ ] | | | |
